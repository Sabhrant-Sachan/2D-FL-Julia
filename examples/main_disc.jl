...
open("test_temp.txt", "w") do io
   ...
   case = (dom=FL2D.disc(b=[2, 2, 2, 2, 2], L1=0.8, L2=0.8),
      N=12, nₚᵣ=128,
...
case_specs = [
   ...
   (dom=d1, N=6, nₚᵣ=64), (dom=d1, N=7, nₚᵣ=64), (dom=d1, N=8, nₚᵣ=64), (dom=d1, N=9, nₚᵣ=128), (dom=d1, N=10, nₚᵣ=128), (dom=d1, N=12, nₚᵣ=128),
...
open("solve_outputs9999_direct.txt", "w") do io
   ...
   cases = [
      (dom=d1, N=10, nₚᵣ=128),
      (dom=d1, N=12, nₚᵣ=128), (dom=d2, N=12, nₚᵣ=128),
      (dom=d2, N=12, nₚᵣ=256), (dom=d3, N=12, nₚᵣ=128),
      (dom=d3, N=12, nₚᵣ=256), (dom=d5, N=12, nₚᵣ=128),
      (dom=d5, N=12, nₚᵣ=256),
      (dom=d5, N=12, nₚᵣ=512),
   ]
...
open("solve_outputs0990_direct.txt", "w") do io
   ...
   cases = [
      ...
      (dom=d3, N=12, nₚᵣ=256), (dom=d5, N=12, nₚᵣ=128),
      (dom=d5, N=12, nₚᵣ=256),
      (dom=d5, N=12, nₚᵣ=512), (dom=d6, N=12, nₚᵣ=128),
      (dom=d6, N=12, nₚᵣ=256),
      (dom=d6, N=12, nₚᵣ=512),
   ]
...
open("solve_outputs0900_direct.txt", "w") do io
   ...
   cases = [
      (dom=d1, N=10, nₚᵣ=128),
      (dom=d1, N=12, nₚᵣ=128), (dom=d2, N=12, nₚᵣ=128), (dom=d3, N=12, nₚᵣ=128), (dom=d5, N=12, nₚᵣ=128),
      (dom=d5, N=12, nₚᵣ=256),
      (dom=d5, N=12, nₚᵣ=512), (dom=d6, N=12, nₚᵣ=256),
      (dom=d6, N=12, nₚᵣ=512),
   ]
...
open("solve_outputs0750_direct.txt", "w") do io
   ...
   cases = [
      (dom=d1, N=10, nₚᵣ=128),
      (dom=d1, N=12, nₚᵣ=128), (dom=d2, N=12, nₚᵣ=128), (dom=d3, N=12, nₚᵣ=128), (dom=d5, N=12, nₚᵣ=256), (dom=d6, N=12, nₚᵣ=256),
   ]
...
open("solve_outputs0500_direct.txt", "w") do io
   ...
   cases = [
      (dom=d1, N=10, nₚᵣ=128),
      (dom=d1, N=12, nₚᵣ=128), (dom=d2, N=12, nₚᵣ=128), (dom=d3, N=12, nₚᵣ=128), (dom=d5, N=12, nₚᵣ=128),
      (dom=d5, N=12, nₚᵣ=256), (dom=d6, N=12, nₚᵣ=128),
      (dom=d6, N=12, nₚᵣ=256),
      (dom=d6, N=12, nₚᵣ=512),
   ]
