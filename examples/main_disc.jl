...
function run_one_disc!(case; s::Float64, p::Int, nJac::Int=2)

   f!, uex = makediscfuex(nJac, s)
...
function run_one_disc!(io, case; s::Float64, p::Int, nJac::Int=2)
...
d7 = FL2D.disc(b=[7, 7, 7, 7, 7], a=[5, 5, 5, 5, 6], L1=0.8, L2=0.8);
d8 = FL2D.disc(b=[8, 8, 8, 8, 8], a=[6, 6, 6, 6, 7], L1=0.8, L2=0.8);
...
#-------------- For showing table ------------------
open("solve_outputs0750_showdisc.txt", "w") do io
...
run_one_disc!(case; s=s, p=p, nJac=2);
