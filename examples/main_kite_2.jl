...
if ~isfile("kite_ex_Eg2.bin")
    ...
    domf = FL2D.kite(b=[4, 5, 9, 9, 5, 4, 5, 5, 5, 5, 4, 4],
...
Uexf = FL2D.load_vec_bin("kite_ex_Eg2.bin");
...
dom = FL2D.kite(b=[3, 2, 5, 5, 2, 3, 2, 2, 2, 2, 2, 2],
...
dom = FL2D.kite(b=[4, 3, 7, 7, 3, 4, 3, 4, 4, 3, 3, 3],
...
dom = FL2D.kite(b=[4, 4, 8, 8, 4, 4, 4, 4, 4, 4, 4, 4],
    a=[3, 3, 7, 7, 3, 3, 3, 5, 5, 3, 2, 2]);

FL2D.refine!(dom, 1, 2, [5, 8, 9, 12, 153, 156, 157, 160]);
...
dom = FL2D.kite(b=[4, 4, 8, 8, 4, 4, 4, 4, 4, 4, 3, 3],
    a=[4, 3, 7, 7, 3, 4, 3, 6, 6, 3, 3, 3]);

FL2D.refine!(dom, 1, 2, [13, 16, 165, 168]);
